...
object TelemetryProvider {
     ...
     */
    private fun computeReadyToTakeoff(): Boolean = DeviceStatusManager.getInstance().getCurrentDJIDeviceStatus() == DJIDeviceStatus.NORMAL
    ...
    ): FrameMetadata = captureCachedMetadata(frameNumber, timestampNs, frameWidth, frameHeight, droneName)
