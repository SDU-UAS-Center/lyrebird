            ...
            listener =
                object : WebRTCStreamer.WebRTCStreamerListener {
                    ...
                    override fun onMetrics(metrics: WebRTCStreamMetrics) {
                        // Qualified on purpose: an unqualified call resolves back to this
                        // override (the listener is the innermost receiver) and recurses
                        // until the stack overflows.
                        this@V5WebRtcStreamerFactory.onMetrics(metrics)
                    }
                }
        }
    }
