...
internal class V5FlightStateEffects(
    ...
    override fun onTakeoff() {
        // The status follows the aircraft, not just the commands this app issued: a take-off from
        // the UXSDK's own control or from the RC leaves the same aircraft in the air (see
        // DroneController.onTelemetryTakeoff).
        DroneController.onTelemetryTakeoff()
    ...
    override fun onLanded() {
        DroneController.onTelemetryLanded()
