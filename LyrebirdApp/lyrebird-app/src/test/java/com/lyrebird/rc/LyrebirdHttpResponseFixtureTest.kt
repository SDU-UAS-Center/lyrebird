...
class LyrebirdHttpResponseFixtureTest {
    ...
    private val handler = LyrebirdHttpCommandHandler(FakeHost(flight), FakeSink())
...
private class FakeFlight : LyrebirdFlightPort {
    ...
    override fun setRthAltitude(altitudeM: Int): CommandResult = error("not used by this fixture")

    override fun setMaxFlightHeight(heightM: Int): CommandResult = error("not used by this fixture")

    override fun setMaxFlightDistance(distanceM: Int): CommandResult = error("not used by this fixture")

    override fun setDistanceLimitEnabled(enabled: Boolean): CommandResult = error("not used by this fixture")

    override fun setRcControlMode(mode: String): CommandResult = error("not used by this fixture")

    override fun requestRcPairing(): CommandResult = error("not used by this fixture")

    override fun stopRcPairing(): CommandResult = error("not used by this fixture")
